<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            @if ($errors->any())
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-1 p-2">
                    <ul>
                        @foreach ($errors->all() as $error)
                            <li class="text-red-600 mb-1 text-xl font-medium">{{ $error }}</li>
                        @endforeach
                    </ul>
                </div>
            @endif
                ...
                <form method="POST" action="{{ route('operators.store') }}">
                    ...
                    <div class="grid gap-6 mb-6 md:grid-cols-2 p-5">
                        ...
                        <div>
                            ...
                            <input type="text" id="company" name="last_name"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                required />
                        </div>
                        <div>
                            <label for="last_name"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Email (escribir en minúscula)</label>
                        ...
                        <div>
                            ...
                            <input type="number" id="company" name="phone"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                required />
                        </div>
                        <div>
                            <form class="max-w-sm mx-auto">
                                <label for="countries"
                                    ...
                                    sangre</label>
                                <select id="countries" name="type_blood"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        <div>
                            <label for="company"
                                ...
                                contratación</label>
                            <input type="date" id="company" name="date_contract"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                required />
                        </div>
