                ...
                <div class="p-6 text-gray-900">
                    <div class="flex justify-end">
                        <a href="{{ route('operators.create') }}">
                            ...
                            focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2" href="{{ route('operators.create')}}">Crear Operario</button>
                        </a>
                    </div>
